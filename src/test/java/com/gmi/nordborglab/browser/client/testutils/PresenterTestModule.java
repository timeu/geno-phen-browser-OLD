...
public abstract class PresenterTestModule extends JukitoModule {
	...
	protected void configureTest() {
	    ...
	    bind(ServiceLocator.class).to(RequestFactoryHelper.MockServiceLocator.class).in(Singleton.class);
	    bind(ServiceLayerDecorator.class).to(RequestFactoryHelper.MockServiceDecorator.class).in(Singleton.class);
