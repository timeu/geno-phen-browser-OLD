...
public class RequestFactoryHelper {
  ...
  public static class MockServiceLocator implements ServiceLocator {
  ...
  public static class MockEntityLocator extends SpringEntitiyLocator {
  ...
  public static class MockServiceDecorator extends ServiceLayerDecorator {
    @Override
	...
	public <T extends Locator<?, ?>> T createLocator(Class<T> clazz) {
		return  (T) entityLocator;
	}
   
    
    
  }
  private static MockEntityLocator entityLocator = new MockEntityLocator();
